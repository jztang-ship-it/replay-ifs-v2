...
export default function TopNav() {
  ...
  return (
    ...
    <header className="shrink-0 h-20 bg-slate-950 border-b border-slate-900 flex items-center justify-between px-4 relative z-50">
      ...
      {/* 1. BIG CLICKABLE LOGO (Upper Left) */}
